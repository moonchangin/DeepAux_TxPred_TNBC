...
results_df.to_csv(f'./output/MCCV_PCA_gradnorm_{main_task_name}_{args.mccv}.csv', index=False)
# results_df.to_csv(f'./output/MCCV_PCA_gradnorm_{args.mccv}.csv', index=False)
